...
const styles = StyleSheet.create({
  ...
  avatarText: { fontFamily: F.serif, fontSize: 28, color: C.white },
  ...
  stat: { flex: 1, backgroundColor: C.paper, borderWidth: 1, borderColor: C.line, borderRadius: R.md, paddingVertical: 16, alignItems: 'center', ...SHADOW.sm },
  statValue: { fontFamily: F.serif, fontSize: 24, color: C.ink },
  statLabel: { fontFamily: F.sans, fontSize: 12, color: C.ink2, marginTop: 2 },
